...
async function seedPlaces() {
  ...
  try {
    const newPlace = await Promise.all(places.map(async place => {
        ...
        if (!geoData) {
          geoData = { type: "Point", coordinates: [115.216667,-8.65, ] };
        }
        return {
          ...place,
          author: "65991af784ac7e5b4818143a",
          images: {
            url: "public\\images\\image_1704900160391_744876215.jpeg",
            filename: "image_1704900160391_744876215.jpeg",
          },
          geometry: geoData,
        };
      })
